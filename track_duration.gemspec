...
require_relative 'lib/track_duration/version'

Gem::Specification.new do |spec|
  spec.name = 'track_duration'
  spec.version = TrackDuration::VERSION
  ...
  spec.homepage = 'https://github.com/rodrigovdb/track_duration'
  spec.license = 'GPLv3'
